<div class="top-content">
            ...
            <div class="inner-bg mx-5 my-5 py-5 bg-color1 text-light">
                <div class="container">
                	
                   
                    
                    <div class="row">
                        <div class="col-sm-5 bg-dark px-2 py-2">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="" method="post" class="login-form">
										...
										<p><placeholder=<?=$emailnot?> </p><br>
				                        <button type="submit" class="btn text-light colorbtn HOVERBT mx-2 my-2 ">Sign in!</button>
				                    </form>
			                    </div>
		                    </div>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box bg-dark px-2 py-2 ">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Sign up now</h3>
